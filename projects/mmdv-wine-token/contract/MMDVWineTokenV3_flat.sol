...
// File @openzeppelin/contracts/token/ERC20/extensions/ERC20Pausable.sol@v5.0.2
...
// File contracts/MMDVWineTokenV3.sol
...
contract MMDVWineTokenV3 is ERC20, ERC20Capped, ERC20Burnable, ERC20Pausable, Ownable {
    ...
    // Precio simb├│lico educativo: 10 "unidades" por token (no usamos euros on-chain)
    uint256 public constant BASE_PRICE_UNITS = 10;

    // Guardamos cu├ínto compr├│ cada direcci├│n y cu├índo empez├│ a holdear
    struct Holding {
        uint256 amount;
    ...
    // --- Funciones educativas de gesti├│n del lote ---

    /// @notice Mint educativo: el owner reparte tokens de un lote a los participantes.
    /// @dev amount est├í en UNIDADES ENTERAS (sin 18 decimales de por medio).
    ...
    /// @notice Devuelve el multiplicador de valor te├│rico en funci├│n del tiempo.
    /// 0ÔÇô1 a├▒o: 1.00x, 1ÔÇô2 a├▒os: 1.05x, 2ÔÇô3 a├▒os: 1.10x, 3ÔÇô4 a├▒os: 1.15x, >4 a├▒os: 1.20x
    ...
    /// @notice Bonus te├│rico de fidelidad tras 4 a├▒os (10% extra de tokens).
    ...
    // --- Resoluci├│n de herencia m├║ltiple en OZ v5 ---
    // Aqu├¡ se combinan las l├│gicas de ERC20, Capped y Pausable.
